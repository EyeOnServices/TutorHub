        ...
        <div className="container mb-5 mb-md-6">
            <div className="row justify-content-md-center">
                <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6 text-center">
                    <h2 className="mb-4 display-5">Services</h2>
        ...
        <div className="container overflow-hidden">
            <div className="row gy-5 gy-md-6 gx-xl-6">
                ...
                <div className="text-center">
                    ...
                    <h5 className="m-2">Tutor Searching</h5>
                    <p className="m-0 text-dark">Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, vel placerat magna mauris mollis maximus est.</p>
                </div>
                </div>
                <div className="col-12 col-sm-6 col-lg-4">
                    <div className="text-center">
                        ...
                        <h5 className="m-2">Relaible Tutor</h5>
                        <p className="m-0 text-dark">Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, vel placerat magna mauris mollis maximus est.</p>
                    </div>
                </div>
                <div className="col-12 col-sm-6 col-lg-4">
                    <div className="text-center">
                        ...
                        <h5 className="m-2">Digital ClassNameroom</h5>
                        <p className="m-0 text-dark">Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, vel placerat magna mauris mollis maximus est.</p>
                    </div>
                </div>
                <div className="col-12 col-sm-6 col-lg-4">
                    <div className="text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-4-circle-fill text-primary mb-4" viewBox="0 0 16 16">
                            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0ZM7.519 5.057c-.886 1.418-1.772 2.838-2.542 4.265v1.12H8.85V12h1.26v-1.559h1.007V9.334H10.11V4.002H8.176c-.218.352-.438.703-.657 1.055ZM6.225 9.281v.053H8.85V5.063h-.065c-.867 1.33-1.787 2.806-2.56 4.218Z" />
                        </svg>
                        <h5 className="m-2">Report Generator</h5>
                        <p className="m-0 text-dark">Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, vel placerat magna mauris mollis maximus est.</p>
                    </div>
                </div>
                <div className="col-12 col-sm-6 col-lg-4">
                    <div className="text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-5-circle-fill text-primary mb-4" viewBox="0 0 16 16">
                        ...
                        <h5 className="m-2">Appointment Scedulor</h5>
                        <p className="m-0 text-dark">Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, vel placerat magna mauris mollis maximus est.</p>
                    </div>
                </div>
                <div className="col-12 col-sm-6 col-lg-4">
                    <div className="text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-6-circle-fill text-primary mb-4" viewBox="0 0 16 16">
                        ...
                        <h5 className="m-2">Feadback and Reviews</h5>
                        <p className="m-0 text-dark">Vestibulum bibendum, lorem a blandit lacinia, nisi velit posuere nisl, vel placerat magna mauris mollis maximus est.</p>
                    </div>
                </div>
            </div>
